+++
title = "Ich fürchte mich so vor des Reviewers Wort"
date = 2026-05-28
draft = false
tags = ["Poetry"]
+++
...
A short pastiche of Rainer Maria Rilke's *Ich fürchte mich so vor der Menschen Wort* (from *Mir zur Feier*, 1899) — reimagined for the modern code review.

The original Rilke is about how categorical naming (*"this is called dog and that is called house"*) flattens the world; *"die Dinge singen hör ich so gern. Ihr rührt sie an: sie sind starr und stumm"* — *I love so much to hear the things sing. You touch them: they become rigid and mute.* The pastiche keeps the structure (three quatrains, ABBA / ABBA / AABB rhyme) and the closing-line punch, substituting source-formatting concerns — sorting, braces, alphabetization, format gates — for Rilke's *Hund / Haus / Berg / Garten*.
